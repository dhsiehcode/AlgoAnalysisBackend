...
public class Part4Test {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        if (!flag) {
            System.out.println("\nTotal score for Part 3: " + 0.0 + "/5.0");
        } else {
            System.out.println("\nTotal score for Part 4: " + 5.0 + "/5.0");
        }
    ...
    private static int cancelOrder() throws NoSuchAlgorithmException {
        ...
        c.setPosInQueue(-1);
        System.out.println("Expected time of cancelled: " + c.getOrderDeliveryTime() + " (" + c.getName() + ") ");
    ...
    private static void updateOrder() throws NoSuchAlgorithmException {
        ...
        System.out.print("Expected update: " + inQueue.get(i).getName() + " from " + inQueue.get(i).getOrderDeliveryTime());
        inQueue.get(i).setOrderDeliveryTime(newDeliveryTime);
        System.out.println(" to " + newDeliveryTime);
